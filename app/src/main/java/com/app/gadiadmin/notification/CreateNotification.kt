package com.app.gadiadmin.notification
...
import com.app.gadiadmin.manageservice.ManageserviceDataClass
import com.app.gadiadmin.manageservice.RecyclerAdapter
...
class CreateNotification : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firestore.collection("Notifications").addSnapshotListener(object : EventListener<QuerySnapshot> {
            override fun onEvent(value: QuerySnapshot?, error: FirebaseFirestoreException?) {

                if (error!=null){
                    Log.e("firestore", error.message.toString())
                    Toast.makeText(this@CreateNotification,"Error"+error.message.toString(),Toast.LENGTH_LONG).show()
                }
