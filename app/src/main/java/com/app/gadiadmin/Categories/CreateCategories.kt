package com.app.gadiadmin.Categories
    ...
    private fun fetchCategories() {
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@CreateCategories,"failed to load data",Toast.LENGTH_SHORT).show()
            }
        })
    }
        ...
        storageRef.putFile(imageUri!!)
            .addOnSuccessListener { taskSnapshot ->
                taskSnapshot.storage.downloadUrl.addOnSuccessListener { downloadUri ->
                    ...
                    imageViewProfile.setImageResource(R.drawable.splashscreen) // Set your default image here
